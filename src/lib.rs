// src/lib.rs
/*
 * Core library for BaseLayerChain
 */
...
#[derive(Debug)]
pub struct BaseLayerChainProcessor {
    verbose: bool,
    processed_count: usize,
}

impl BaseLayerChainProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting BaseLayerChain processing");
    
    let mut processor = BaseLayerChainProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = BaseLayerChainProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = BaseLayerChainProcessor::new(false);
